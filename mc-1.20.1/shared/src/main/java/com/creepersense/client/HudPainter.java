...
public final class HudPainter {
    ...
    private static int[] placeOnInsetRect(int cx, int cy, float dx, float dy, int left, int right, int top, int bottom) {
        ...
        int px = Math.round(cx + dx * tt);
        int py = Math.round(cy + dy * tt);
    ...
    private static final ResourceLocation MEME_WARN =
            new ResourceLocation("creepersense", "textures/gui/meme/meme-warning-triangle.png");
    private static final ResourceLocation MEME_SPEECH =
            new ResourceLocation("creepersense", "textures/gui/meme/meme-speech-bubble-watch-out-bro.png");
    private static final ResourceLocation MEME_CAT =
            new ResourceLocation("creepersense", "textures/gui/meme/meme-cat.png");
